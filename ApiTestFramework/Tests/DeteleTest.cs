...
public class DeleteTest : TestBase
{
    ...
    {
        ReportHelper.LogMessage(_test, Status.Info, $"Deleting a valid user with id: {id}");
    ...
    {
        ReportHelper.LogMessage(_test, Status.Info, $"Deleting an invalid user with id: {id}");
